...
- В пользовательских текстах английское название партнёра пишется только как **`Grinvich`**. Технические идентификаторы (`GREENWICH`, имена API, моделей и функций) не переименовывать.
