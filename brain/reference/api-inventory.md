...
> **Сгенерировано:** 2026-08-20T08:20:18.483Z
> **Файлов route.ts:** 127  
...
| GET | `/api/dashboard/wowstorg/operations` | `src/app/api/dashboard/wowstorg/operations/route.ts` |
| POST | `/api/dashboard/wowstorg/order-attention` | `src/app/api/dashboard/wowstorg/order-attention/route.ts` |
...
| GET | `/api/inventory/positions/export` | `src/app/api/inventory/positions/export/route.ts` |
...
| GET, POST, DELETE | `/api/me/push-subscriptions` | `src/app/api/me/push-subscriptions/route.ts` |
...
| GET, PATCH, DELETE | `/api/standalone-estimates/[id]` | `src/app/api/standalone-estimates/[id]/route.ts` |
