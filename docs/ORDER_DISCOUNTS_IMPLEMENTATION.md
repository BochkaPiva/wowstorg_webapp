...
- Для Greenwich `payMultiplier` определяется текущим рейтинговым уровнем сотрудника. Уровни и скидки настраиваются складом; налог не вшивается в цену реквизита или услуг.
...
- В складском checkout скидка редактируется компактно внутри правого финансового итога; отдельного большого блока в основной форме нет.
- Там же склад выбирает оплату клиента: безнал с налогом 6% или наличные без клиентского налога. Для Greenwich оба элемента скрыты, его прежний сценарий не меняется.
