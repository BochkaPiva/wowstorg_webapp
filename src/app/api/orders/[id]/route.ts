...
export async function GET(
  ...
  const serialized: Record<string, unknown> = {
    ...
    deliveryInternalPaymentMethod: order.deliveryInternalPaymentMethod,
    ...
    montageInternalPaymentMethod: order.montageInternalPaymentMethod,
    ...
    demontageInternalPaymentMethod: order.demontageInternalPaymentMethod,
